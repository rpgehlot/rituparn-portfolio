        ...
        {items.map((item, idx) => (
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className="relative z-20 md:text-lg text-sm leading-[1.6] font-normal text-neutral-800 dark:text-white">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                    <div className="me-3">
                        <img width={60} height={60} src={item.profileImg || "/profile.svg"} alt="profile"  className="rounded-full"/>
                    </div>
                  <span className="flex flex-col gap-1">
