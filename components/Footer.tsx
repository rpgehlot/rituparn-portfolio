  ...
  return (
    <footer className='w-full pb-20 mb-[100px] md:mb-5' id="contact">
        ...
        <div className='flex flex-col items-center'>
            ...
            <a href='mailto:rpgehlot1991@gmail.com'>
                <MagicButton 
        ...
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>
                Copyright © 2025 Rituparn
            </p>
            <div className='flex items-center md:gap-3 gap-6 mt-4'>
                {socialMedia.map((profile) => (
                    <div key={profile.id} className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-150 bg-opacity-75 bg-black-200 rounded-lg border border-black-100'>
